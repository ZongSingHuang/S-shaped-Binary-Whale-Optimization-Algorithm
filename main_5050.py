...
for i in range(times):
    ...
    optimizer = bWOA_S(fit_func=loss1, 
    ...
    optimizer = bWOA_S(fit_func=loss2, 
    ...
    optimizer = bWOA_S(fit_func=loss3, 
    ...
    optimizer = bWOA_S(fit_func=loss4, 
    ...
    optimizer = bWOA_S(fit_func=loss5, 
    ...
    optimizer = bWOA_S(fit_func=loss6, 
    ...
    optimizer = bWOA_S(fit_func=loss7, 
    ...
    optimizer = bWOA_S(fit_func=loss8, 
    ...
    optimizer = bWOA_S(fit_func=loss9, 
    ...
    optimizer = bWOA_S(fit_func=loss10, 
    ...
    optimizer = bWOA_S(fit_func=loss11, 
    ...
    optimizer = bWOA_S(fit_func=loss12, 
    ...
    optimizer = bWOA_S(fit_func=loss13, 
    ...
    optimizer = bWOA_S(fit_func=loss14, 
    ...
    optimizer = bWOA_S(fit_func=loss15, 
    ...
    optimizer = bWOA_S(fit_func=loss16, 
    ...
    optimizer = bWOA_S(fit_func=loss17, 
    ...
    optimizer = bWOA_S(fit_func=loss18, 
